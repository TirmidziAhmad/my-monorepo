            ...
            .map((project, index) => (
              ...
              >
                ...
                >
                  ...
                  <div
                    className={`relative h-48 -mx-8 -mt-8 mb-6 bg-gradient-to-br ${project.gradient} flex items-center justify-center overflow-hidden rounded-t-2xl border-b border-foreground/10`}
                  >
